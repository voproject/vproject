...
type Props = {
  // Off on the pages that are public while the rest of the site is gated:
  // there the nav would only lead to the coming-soon page, and UNISCITI has
  // no form to scroll to.
  showNav?: boolean
  homeHref?: string
}

export function VolpinVeritasHeader({ showNav = true, homeHref = "/" }: Props) {
  return (
